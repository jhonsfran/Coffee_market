...
class ProductoController extends AbstractActionController {
        ...
        try {
            ...
            switch ($action) {
                ...
                case 'getById':
                    ...
                    break;
                default :
                    $partialUbicacion = $this->forward()->dispatch('Producto\Controller\ubicacion', array('action' => 'admin'));
                    $page = new ViewModel();
                    $page->addChild($partialUbicacion, 'partialUbicacion');
                    return $page;
                    break;
            }
        } catch (\Exception $e) {
    ...
    public function formlyAction() {
        $formulario = Utilidades::getFormly('ORM\Entity\Producto');
